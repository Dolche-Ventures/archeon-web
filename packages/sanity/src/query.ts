...
const buttonsFragment = /* groq */ `
  buttons[]{
    ...
    "href": select(
      ...
      url.type == "anchor" => "/services#" + url.anchor,
      url.href
    ),
  }
`;
...
const featureCardsIconWithCTABlock = /* groq */ `
  _type == "featureCardsIconWithCTA" => {
    ...,
    ${richTextFragment},
    ${buttonsFragment},
    "cards": array::compact(cards[]{
      ...
      "href": select(
        ...
        link.type == "anchor" => "/services#" + link.anchor,
        link.href
      ),
    })
  }
...
const imageFeatureCardsBlock = /* groq */ `
  _type == "imageFeatureCards" => {
    ...,
    ${richTextFragment},
    ${buttonsFragment},
    "cards": array::compact(cards[]{
...
const inquiryFormSectionBlock = /* groq */ `
...
const servicePillarsSectionBlock = /* groq */ `
  _type == "servicePillarsSection" => {
    ...,
    "pillars": array::compact(pillars[]{
      anchorId,
      eyebrow,
      icon,
      title,
      ...
      imagePosition,
      "subServices": array::compact(subServices[]{
        title,
        description,
        ctaText,
        "ctaLink": ctaLink{
...
const valuePropositionSectionBlock = /* groq */ `
...
const caseStudiesHeroBlock = /* groq */ `
  _type == "caseStudiesHero" => {
    ...,
    featuredCaseStudy {
      ...,
      ${imageFragment}
...
const caseStudyEditorialBlocks = /* groq */ `
  _type == "csIndividualCaseStudy" => {
    ...,
    sections[]{
      ...,
      _type == "hero" => {
...
const pageBuilderFragment = /* groq */ `
  pageBuilder[]{
    ...
    ${featureCardsIconWithCTABlock},
    ${imageFeatureCardsBlock},
    ${imageTextBlockFragment},
    ${subscribeNewsletterBlock},
    ${imageLinkCardsBlock},
    ${richTextBlockFragment},
    ${inquiryFormSectionBlock},
